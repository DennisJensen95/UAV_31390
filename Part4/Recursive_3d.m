function [ route ] = Recursive_3d( map, start, end_, parent_node, closed, children)
    % Check if length_cost was given

    if ~exist('parent_node', 'var')
    ...
    if ~(parent_node.position(1) == end_(1) && ...
                    ...
                    if ~(x == 0 && y == 0 && z == 0)
                        ...
                        if ~(node_pos(1) < 1 || node_pos(1) > max_x || ...
                            ...
                            if ~(map(node_pos(1), node_pos(2), node_pos(3)) == 1)
                                ...
                                temp_node.f = wh*temp_node.h + wg*temp_node.g;
        ...
        route = Recursive_3d( map, start, end_, parent_node, closed, children);
